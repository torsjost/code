...
* nphi same as in hgw4.f !!
      ...
      parameter (maxp=1500,kdim=2,maxk=10000)
     ...
     .                 e1(2)
      ...
      double precision Gnnp(2,2,maxk)  !ky-d
...
* Open files.
      ...
      open(unit=116,file='fort.116',status='UNKNOWN')
      open(unit=117,file='fort.117',status='UNKNOWN')
...
*      read (116,'(i4,5f12.6)') ip0, phi0
      ...
      write (115,'(i4,5f12.6)') ip0, phi0
      if(dabs(phi0-phi).ge.tol) stop 'Error phi'
...
* Determine the derivatives!
     ...
     .                    deryEn 
      ...
      csum1 = csum1 + Gnnp(1,1,icount)*ctemp1
...
*      write(6,*)'icount and numk:',icount,numk
     ...
     .-dimag(csum1*volwgt*fact)

      write(2,'(3f10.4)') phi/pi, -dimag(csum1*volwgt*fact) 
